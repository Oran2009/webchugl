...
var METHOD_GROUPS = [
    ...
    { title: 'VM',                  methods: ['getCurrentTime', 'now', 'getActiveShreds', 'getLastError', 'getGlobalVariables', 'setParamInt', 'getParamInt', 'setParamFloat', 'getParamFloat', 'setParamString', 'getParamString', 'clearChuckInstance', 'clearGlobals'] },
